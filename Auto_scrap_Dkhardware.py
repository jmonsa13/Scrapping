...
output_path_toilet = './XX_Data/Dkhardware_toilet-' + str(fecha.year) + '_' + str(fecha.month) + '.csv'
...
def Dkhardware_data(elem, soup_html):
    """
    Programa que toma la información general de una pagina de producto del market place de DKhardware
    """
