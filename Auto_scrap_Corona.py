...
output_path_toilet = './XX_Data/' + folder + '/Corona_toilet-' + str(fecha.year) + '_' + str(fecha.month) + '.csv'
output_path_asiento = './XX_Data/' + folder + '/Corona_asiento-' + str(fecha.year) + '_' + str(fecha.month) + '.csv'
