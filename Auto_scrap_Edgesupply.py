...
output_path_toilet = './XX_Data/' + folder + '/Edgesupply_toilet-' + str(fecha.year) + '_' + str(fecha.month) + '.csv'
...
def edgesupply_data(elem, soup_html):
    """
    Programa que toma la información general de una página de producto del market place de edgesupply
    """
